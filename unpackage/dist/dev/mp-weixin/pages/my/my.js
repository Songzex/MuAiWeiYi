...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    o: _ctx.$imagePreUrl + "hong_fenxiang.png",
    p: _ctx.$imagePreUrl + "hong_mendianxinxi.png",
    q: _ctx.$imagePreUrl + "hong_ip.png",
    r: _ctx.$imagePreUrl + "hong_yunying.png",
    s: _ctx.$imagePreUrl + "hong_dingdan.png",
    t: _ctx.$imagePreUrl + "hong_tuandui.png",
    v: _ctx.$imagePreUrl + "hong_zhoubian.png",
    w: _ctx.$imagePreUrl + "hong_kefu.png"
  };
}
